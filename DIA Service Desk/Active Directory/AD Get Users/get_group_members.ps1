...
:mainLoop while ($true) {
    ...
    $rows | Export-Csv -Path "C:\SD Datacom Tools\burgerking\Active Directory\AD Get Users\Exported Member Lists\$($user_input) $(Get-Date -Format 'dd-MM-yy').csv" -NoTypeInformation
