...
Title:   get_names_lower.ps1
Author:  kian.mortimer@datacom.com
Date:    08/06/24
Version: 1.5

Description: 
- Script to get all the users with lowercase names

#>

# Change window title
$host.ui.RawUI.WindowTitle = "Find Users With lowercase Names"

Write-Host "`n > Searching Active Directory... "

# Get all users in AD that have names in full lowercase
...
# Check whether we found any users with lowercase names
if (!$results) {
...
# getting all attributes of all users, not just the users with full lowercase names
...
# rrrrrraaaaaaaaaaaaaaaaaaaaaagggghhhhhhhhhh